/*slideを３枚から４枚に増やした場合「slide」で検索したときの近くにあるfor文の真ん中の数字をいじる？
とりあえず対応させる画像はslide1、slide2・・＋拡張子に変える*/
...
jQuery(function ($) {
    var now_id = 1;
    var next_id = 2;
    var max_image = $("#graphic ul li img").size();
    function changeImage() {
        ...
        var point = $(
            '#graphic ul li img[class="image' + next_id + '"]'
        ).parent();
        $('#graphic ul li img[class="image' + now_id + '"]')
            .parent()
