...
return [
    ...
    'integer' => 'ここの:attributeは整数値（半角英数）が値として入力されるようにしてください。なお、その際にはカテゴリ名の表を参考にしてください。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　（※なお、商品登録画面では、プルダウンリストの中からいずれかを選択してください。）',
    // :attributeや :valueには、下で定義した単語がvalidatedで制限した条件に合わせて、適切な（エラーメッセージに使う）単語が代入される。
    ...
    'required' => 'ここの欄（:attribute）が入力されていません。（必須項目です）',
